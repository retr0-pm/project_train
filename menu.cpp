...
void Menu::Start(Core &obj) {
	...
	while(true){
		...
		case 0:
			...
			cout << "1. Работа с базой данных пунктов" << endl;
		...
		case 1:
			cout << "Выберите действие:" << endl;
			cout << "1. Добавть пункт" << endl;
                        cout << "2. Удалить пункт" << endl;
                        cout << "3. Редактировать пункт" << endl;
                        cout << "4. Вывести базу данных пункт" << endl;
                        cout << "5. Поиск пункта по названию" << endl;
                        cout << "0. Назад" << endl;
                        cout << "Ваш выбор: ";
			cin >> swp;
			cout << endl;
		...
		case 2:
			...
			cout << "6. Поиск рейса по пунктам" << endl;
                        cout << "0. Назад" << endl;
                        cout << "Ваш выбор: ";
			cin >> swp;
			cout << endl;
		...
		cout << "Выберите действие (0 для вызова инструкции): ";
		cin >> sw;
		cout << endl;
	}
}
